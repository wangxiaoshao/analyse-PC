<template>
    <div class="group-management">
        <div class="group-operation">
            ...
            <el-button class="create-btn" type="primary" @click="openDialog"
                >创建分组</el-button
            >
        </div>
        <div class="table">
            ...
            >
                ...
                <el-table-column label="分组所属" align="center">
                ...
                <el-table-column label="操作" align="center" width="180">
                    <template slot-scope="scope">
                        <el-button
                            @click="handleClickToDetail(scope.row)"
                            type="text"
                            size="small"
                            >编辑成员</el-button
                        >
        ...
        <create-group-dialog
            :creatTitle="creatTitle"
            :editId="editId"
            @close="close"
            :creategroupdialogVisible="creategroupdialogVisible"
        ></create-group-dialog>
    </div>
</template>
...
export default {
    ...
    methods: {
        ...
        handleClickToDetail(row) {
            this.$router.push({
                path: `/group-management/group-detail/${row.id}/${row.ownerType}`,
            });
        },
        // typeChange
        // 单位内设机构
