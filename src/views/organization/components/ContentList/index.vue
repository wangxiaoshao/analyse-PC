<template>
    <div class="content-list">
        <div class="button-wrap">
            <el-button
                @click="sortBtnFlag"
                :disabled="!hasRight('departmentOrder')"
                >调整排序</el-button
            >
        </div>
        ...
        >
            ...
            >
                <template slot-scope="scope">
                    <span v-show="scope.row.state === 0" style="color: #f56c6c;"
                        >待审核</span
                    >
                    <span v-show="scope.row.state === 1" style="color: #67c23a;"
                        >已审核</span
                    >
                    <span v-show="scope.row.state === 2" style="color: #67c23a;"
                        >正常</span
                    >
                </template>
            </el-table-column>
        ...
        <el-dialog :visible.sync="showSortDilog" width="420px">
            ...
            <div class="sort-ipt">
                ...
                <div style="display: inline-block;">
                    <el-input
                        v-model="sortValue"
                        placeholder="请输入排序目标序号"
                    ></el-input>
                </div>
            </div>
            <div slot="footer" class="dialog-footer">
                <el-button type="primary" @click="submitNumSort" width="120px"
                    >确 定</el-button
                >
            </div>
        </el-dialog>
...
export default {
    ...
    methods: {
        ...
        getIndex($index) {
            return (
                (this.contentPage.current - 1) * this.contentPage.limit +
                $index +
                1
            );
        },
