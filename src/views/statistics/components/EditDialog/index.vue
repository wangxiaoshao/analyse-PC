            ...
            <el-scrollbar :style="scrollStyle">
                ...
                >
                    ...
                    <div class="confirm-btn">
                        <el-button type="danger" @click="submitForm('editForm')"
                            >确 定</el-button
                        >
                    </div>
                </el-form>
...
export default {
    ...
    data() {
        ...
        return {
            ...
            currentSelect: {},
            rules: {
                areaId: [{ validator: validateAreaName, trigger: "blur" }],
                type: [
    ...
    computed: {
        ...
        editForm() {
            if (this.current) {
                let currentForm = this.current;

                if (typeof currentForm.areaId === "string") {
                    let arr = currentForm.areaId.split(",");
                    currentForm.areaId = arr;
                }
                return this.current;
            } else {
