<template>
    <div class="person-detail-content" v-loading="loading">
        ...
        <el-footer
            class="add-person-footer"
            v-if="this.$route.name === 'PersonDetail'"
        >
            <el-button type="primary" @click="nextDetail" v-if="stepOneFlag"
                >下一步</el-button
            >
            <el-button type="primary" @click="lastDetail" v-if="stepTwoFlag"
                >上一步</el-button
            >
        </el-footer>
    </div>
                    ...
                    (res) => {
                        ...
                        if (res.data.nodeType === 3) {
                            api[urlNames["findDepartmentById"]]({
                                ...
                                (res) => {
                                    this.userInfo.identity.departmentId =
                                        res.data.id;
                                    this.userInfo.identity.orgId =
                                        res.data.orgId;
                                    this.oldUserInfo.identity.orgId =
                                        res.data.orgId;
                                    this.oldPostDetail = {
                                        ...this.userInfo.identity,
                                    };
