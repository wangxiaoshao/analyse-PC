<template>
    <div class="dic-edit-dialog">
        <el-dialog
            ...
            :show-close="false"
        >
            <div class="dialog-close" @click="closeDialog('form')">
                ...
                >
                    ...
                    <el-form-item>
                        <el-button
                            type="primary"
                            @click="addDic('form')"
                            v-show="hasRight('dictItemCreate')"
                            >创建</el-button
                        >
            ...
            <el-row :gutter="20" :style="{ marginTop: '20px' }">
                <el-col :span="12" :offset="6">
                    <el-button
                        type="primary"
                        @click="addAllDic"
                        :disabled="foundDicList && foundDicList.length === 0"
                        v-show="hasRight('dictItemCreate')"
                        >保存</el-button
                    >
                    <el-button
...
export default {
    ...
    methods: {
        getDicByTypeList() {
            ...
            api[urlNames["getDicListByType"]](type).then(
                (res) => {
        ...
        addAllDic() {
            ...
            api[urlNames["addDictionary"]](paraems).then(
                (res) => {
                    if (res && res.status === 0) {
        ...
        deleteDic(index, rowData) {
            ...
            this.$confirm("此操作将会永久删除该数据, 确认要删除吗?", "提示", {
