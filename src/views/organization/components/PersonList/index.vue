    ...
    <div class="content-list">
        ...
        <el-dialog title="填写调出说明" :visible.sync="calloutFlag" width="50%">
            ...
            >
                ...
                <el-form-item>
                    <el-button type="primary" @click="submitForm('formCallout')"
                        >确定</el-button
                    >
        ...
        <div class="button-wrap">
            ...
            <el-button @click="sortList" :disabled="!hasRight('userOrder')"
                >调整排序</el-button
            >
            <el-button @click="exportUser" :disabled="!hasRight('userExport')"
                >导出人员</el-button
            >
            <el-button
                size="small"
