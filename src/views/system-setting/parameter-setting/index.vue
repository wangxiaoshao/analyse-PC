<template>
  <div class="parameter-settings">
    <el-tabs v-model="activeName">
      ...
      <el-tab-pane label="个人参数" name="third">
      </el-tab-pane>
    </el-tabs>
  </div>
</template>
  ...
  methods: {
    ...
    systemSubmit (flag) {
      ...
      if (flag === 0) {
        ...
        list.name = 'addressBookSet'
        list.value = this.auditField.checkedNodeAuditList + this.auditField.checkedOrgAuditList + this.auditField.checkedDepAuditList + this.auditField.checkedUserAuditList
      }
