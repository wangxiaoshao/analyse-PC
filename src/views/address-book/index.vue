            ...
            <el-row>
                <el-col :span="6">
                    ...
                    <div class="tree-main">
                        ...
                        <div>
                            <address-book-tree
                                v-if="thisUnit && isShow === 1"
                                @handle-nodeClick="handleNodeClickTree"
                                :thisUnit="thisUnit"
                            ></address-book-tree>
                        </div>
                        <other-address-book-tree
                            v-if="otherUnit && isShow === 2"
                            @handle-nodeClick="handleNodeClickTree"
                            :otherUnit="otherUnit"
                        ></other-address-book-tree>
                    </div>
                        ...
                        <el-breadcrumb separator="/" style="padding: 20px;">
                            ...
                            >
                                <a
                                    ...
                                    @click.prevent="
                                        goCurrentNodeDetail(item.id, index)
                                    "
                                    >{{ item.name }}</a
                                >
                                <span
...
export default {
    ...
    methods: {
        ...
        findDepartmentList(nodeId) {
            api[urlNames["getTree"]]({ bindId: nodeId }).then((res) => {
                console.log(
