    ...
    <div class="site__head">
      <div class="site__head-content">
        <div class="site__head--center">
         <div class="logo"><img :src="app.option.options && app.option.options.systemLogo"></div>
          <div class="name"><h2>{{app.option.options && app.option.options.systemName}}</h2></div>
        </div>
...
<!--          <a href="">联系我们</a>-->
          ...
          <span>{{app.option.user && app.option.user.name}}</span>
