const Application = () =>
    import ('@src/views/application/index.vue')
const ApplicationList = () =>
    import ('@src/views/application/ApplicationList/index.vue')
...
// 申请审核
const WaitApproval = () =>
    import ('@src/views/wait-approval/index.vue')
...
const Approved = () =>
    import ('@src/views/approved/index.vue')
const ApprovedList = () =>
    import ('@src/views/approved/ApprovedList/index.vue')
const ApprovedDetail = () =>
    import ('@src/views/approved/ApprovedDetail/index.vue')
const MyApplication = () =>
    import ('@src/views/my-application/index.vue')
...
const ConfirmInfo = () =>
    import ('@src/views/confirm-info/index.vue')
    // 统计管理
const DataStatistics = () =>
    import ('@src/views/statistics/data-statistics/index.vue')
const DataLog = () =>
    import ('@src/views/statistics/data-log/index.vue')
const DataQuery = () =>
    import ('@src/views/statistics/data-query/index.vue')
const UnitQuery = () =>
    import ('@src/views/statistics/data-query/unit-query/index.vue')
const DepartmentQuery = () =>
    import ('@src/views/statistics/data-query/department-query/index.vue')
const MemberQuery = () =>
    import ('@src/views/statistics/data-query/member-query/index.vue')

const Organization = () =>
    import ('@src/views/organization/index.vue')
...
const Shared = () =>
    import ('@src/views/shared/index.vue')
const ViewManagement = () =>
    import ('@src/views/shared/view-management/index.vue')
const CreateView = () =>
    import ('@src/views/shared/create-view/index.vue')
const GroupManagement = () =>
    import ('@src/views/shared/group-management/index.vue')
const GroupDetail = () =>
    import ('@src/views/shared/group-detail/index.vue')
const AppManagement = () =>
...
const RightsManagement = () =>
    import ('@src/views/shared/rights-management/index.vue')


/* 系统设置 */
const SystemSetting = () =>
    import ('@src/views/system-setting/index.vue')
...
export default [{
    ...
    // 组织机构管理
    {
        ...
        children: [{
            ...
            // },
            // {
            //     path: 'address-book/unit-address-book',
