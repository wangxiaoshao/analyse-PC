        ...
        <div class="log-header">
            <el-form inline>
                ...
                <el-form-item>
                    ...
                    <el-input
                        placeholder="请输入被查询手机号"
                        v-model="logParam.mobile"
                        @blur="iptChange"
                        clearable
                        prefix-icon="el-icon-search"
                        style="width: 160px;"
                ...
                <template v-if="loginLog === 1 || loginLog === 2 || !loginLog">
                    <el-form inline label-width="130px" class="systemDetial">
                        ...
                        <el-form-item label="被查询人">
                            <div class="table-td">
                                {{ detialInfoForm.toUserName }}
                            </div>
                        </el-form-item>
                        <el-form-item label="被查询手机号">
                            <div class="table-td">
                                {{ detialInfoForm.phone }}
                            </div>
                        </el-form-item>
            ...
            api[urlNames[logUrl]](data).then(
                (res) => {
                    ...
                    this.tableData.forEach((item, index) => {
                        this.tableData[index]["description"] =
                            item.name +
                            "于" +
                            " " +
                            item.actionTime +
