      ...
      <area-list @get-area="getAreaId" @close="close" v-model="ruleForm.areaId"></area-list>
        ...
        >
            <el-form-item label="节点名称" prop="name">
                ...
                <div
                    v-if="
                        this.$route.name === 'NodeEdit' ||
                        this.$route.name === 'NodeAdd'
                    "
                >
                    <div
            ...
            <el-form-item label="申请原因" prop="reason">
                ...
                >
                    <div
                        class="el-form-item__error"
                        v-show="this.iptMsgVisible['reason']"
                    >
                        {{ iptMsgInfoStr }}
                    </div>
                </div>
            ...
            <el-form-item label="所属区域" prop="areaId">
                ...
                >
                    <div
                        class="el-form-item__error"
                        v-show="this.iptMsgVisible['areaId']"
                    >
                        {{ iptMsgInfoStr }}
                    </div>
                </div>
            ...
            <el-form-item v-if="isShowEditFlag">
                <el-button
                    ...
                    :disabled="!hasRight('viewNodeSetting')"
                    >{{ submitHtml }}</el-button
                >
...
export default {
    ...
    methods: {
        ...
        showIptMsg(fieldName) {
            if (
                this.app.option.options.nodeAuditFields.indexOf(fieldName) > -1
            ) {
