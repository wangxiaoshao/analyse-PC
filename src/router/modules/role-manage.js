...
const PermissionSet = () =>
    import(
        /* webpackChunkName: "RoleManage" */ "@src/views/role-manage/permission-set/index.vue"
    );
const ScopeAuthorization = () =>
    import(
        /* webpackChunkName: "RoleManage" */ "@src/views/role-manage/scope-authorization/index.vue"
    );
/* 路由 */
export default [
    // 角色管理
