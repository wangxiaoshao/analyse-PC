...
const regionUrlPath = 'https://sisp.servyou.com.cn/apiweb/sisp/1/xzqh/getXzqhFile?code='
...
let loadTool = {
  ...
  /**
	 ...
	 * */
  loadAllRegionData () {
    return Promise.all([loadTool.loadProvinceData(), loadTool.loadCityData(), loadTool.loadAreaData()])
  },
  /**
  ...
  loadRegionData (propertyName, callback) {
    ...
    return loadTool.load(regionUrlPath + propertyName + regionUrlSuffix).then(() => {
