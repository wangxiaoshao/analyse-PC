    ...
    <div class="form-content" v-loading="loading">
        ...
        >
            <div class="detail-title">
                <i
                    class="imenu-icon iconfont iconbumen big-icon"
            ...
            <el-row>
                <el-col :span="12">
                    ...
                    <el-form-item label=" 上级内设机构" prop="parentDep">
                        <el-input
                            v-model="ruleForm.department.parentDep"
                            :disabled="true"
                        ></el-input>
                    </el-form-item>
                    <el-form-item label=" 启用状态" prop="department.removed">
                        <el-switch
                            v-model="ruleForm.department.removed"
            ...
            <el-input v-model="ruleForm.department.shortName"></el-input>
                    ...
                    <el-form-item label="内设机构电话" prop="department.phone">
                        <el-input
                            v-model="ruleForm.department.phone"
                    ...
                    <el-form-item label="上级单位" prop="orgName">
                        <el-input
                            v-model="ruleForm.department.orgName"
                            :disabled="true"
                        ></el-input>
                        <div
                            v-if="
                ...
                <el-col :span="12">
                    <el-form-item label="内设机构介绍" prop="department.duty">
                        ...
                        >
                            <div
                                class="el-form-item__error"
                                v-show="this.iptMsgVisible['duty']"
                            >
                                {{ iptMsgInfoStr }}
                            </div>
                        </div>
...
export default {
    ...
    methods: {
                        ...
                        if (res.data.bindId) {
                            ...
                            if (res.data.nodeType === 2) {
                                api[urlNames["findOrganizationById"]]({
                                    ...
                                    this.ruleForm.department.orgName =
                                        res.data.name;
        ...
        showIptMsg(fieldName) {
            if (
                this.app.option.options.departmentAuditFields.indexOf(
                    fieldName
                ) > -1 &&
                this.$route.name === "DepartmentEdit"
            ) {
            ...
            api[urlNames["findDepartmentById"]](data).then(
                (res) => {
                    ...
                    if (this.$route.name === "DepartmentAdd") {
                        ...
                        this.ruleForm.department.description =
