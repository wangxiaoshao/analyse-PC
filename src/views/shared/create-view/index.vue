                            ...
                            <el-col :span="12">
                                <div class="grid-content bg-purple">
                                    <el-form-item label="视图名称" prop="name">
                                        <el-input
                                            v-model="ViewFrom.name"
                                        ></el-input>
                                    </el-form-item>
                                    <el-form-item label="视图管理员">
                                        <el-select
                                            :disabled="
                                                !hasRight('viewSettingManager')
                                            "
                                    ...
                                    >
                                        <el-input
                                            disabled
                                            v-model="returnViewId"
                                        ></el-input>
                                    </el-form-item>
                                    <el-form-item>
                                        <el-checkbox
                                            v-model="ViewFrom.syncChildren"
                                            >关闭新增机构自动同步</el-checkbox
                                        >
                                        <br />
                                        <span style="color: rgb(114, 116, 119);"
                                            >（组织机构新增单位、内设机构将同步至本视图）</span
                                        >
                                    </el-form-item>
                    ...
                    <el-form ref="form" :model="form">
                        <div class="tree-panel">
                            ...
                            <div class="grid-content drag-tips">
                                <p class="tips-img">
                                    <img
                                        src="@src/common/images/drag-drop.svg"
                                    />
                                </p>
                                <p class="tips-title">
                                    <span
                                        >选择左边的组织机构视图，点击右箭头将机构数据绑定至右边的视图区域。已绑定至右边的视图可实时自动保存至草稿，点击“应用到视图”可将本次编辑应用到最新的共享视图。</span
                                    >
                                </p>
                                <span
                                    class="el-icon-arrow-right rightBtn"
                                    title="保存到草稿视图"
                                    @click="saveToDraft"
                                ></span>
                            </div>
                            <div class="grid-content">
                                ...
                                <el-form-item>
                                    <div
                                        class="select-org select-org123"
                                        ref="coordinates"
                                    >
                                        <el-tree
                                            :data="viewNodeTree"
                                            ...
                                            <div slot-scope="{ node, data }">
                                                ...
                                                <span
                                                    @click="
                                                        deleteNodeTree(data)
                                                    "
                                                    class="delete-icon fa fa-trash-o"
                                                ></span>
                                            </div>
                                        </el-tree>
                                    </div>
        ...
        nodeSelectDragEnd(dragNode, lastNode, seat, e) {
            ...
            if (lastNode === null) {
                ...
                switch (seat) {
                    case "before":
                    case "after":
                        parentId = lastNode.parent
                            ? lastNode.parent.key || -1
                            : -1;
