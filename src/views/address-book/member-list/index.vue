        ...
        <div class="navbar-content">
            <el-breadcrumb separator="/" style="padding: 20px;">
                <el-breadcrumb-item :to="{ path: '/' }"
                    >本单位名称</el-breadcrumb-item
                >
                <el-breadcrumb-item
                    ><a href="/">内设机构</a></el-breadcrumb-item
                >
            </el-breadcrumb>
        </div>
        <div>
            <el-table
                :data="tableData"
                style="width: 100%;"
                class="eltable-member"
            >
                <el-table-column prop="img" label="" width="100" align="center">
                    <template>
                ...
                <el-table-column prop="name" label="" width="180">
                    <template>
                        <div>
                            ...
                            <div class="member-post">职务职务职务职务</div>
                        </div>
                    </template>
                </el-table-column>
