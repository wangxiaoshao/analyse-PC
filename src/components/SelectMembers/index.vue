...
<div class="select-members">
  <el-dialog
    ...
    <div class="top-operate">
      <div class="operate">
        <el-button type="primary" @click="selectCategory = 1" :plain="selectCategory!==1">单位/部门</el-button>
        <el-button type="primary" @click="selectCategory = 0" :plain="selectCategory===1">人员</el-button>
      </div>
      <div class="search">
        <el-popover
          ref="popover"
    ...
    <div class="tree">
      ...
      <div class="transfer">
        <el-transfer v-if="selectCategory===1" @change="treeOrgChange" v-model="treeOrgSelected" :titles="['选择单位/部门', '已选单位/部门']" :data="orgList" :props="{key: 'id',label: 'name'}"></el-transfer>
        <el-transfer v-if="selectCategory!==1" @change="treeMemberChange" v-model="treeMemberSelected" :titles="['选择人员', '已选人员']" :data="memberList" :props="{key: 'uid',label: 'name'}"></el-transfer>
      </div>
    </div>
    <div class="submit">
