    ...
    <div class="account-manage">
        <div class="set-default" v-if="accountList.length > 0">
            <div class="default-warn">
                ...
                >默认帐号用于您一个帐号全站都能使用，若遇到不能使用的业务系统，请切换身份类型即可。
            </div>
            设置默认帐号
            <el-select
        ...
        <el-footer class="add-person-footer">
            <span
                ...
                "
            >
                <el-button type="primary" @click="lastStep" :disabled="false"
                    >上一步</el-button
                >
                <el-button type="primary" @click="fromSublime('addAccount')"
                    >保存</el-button
                >
        ...
        var validateName = (rule, value, callback) => {
            if (value === "") {
                ...
                reg.test(value)
                    ...
                    : callback(
                          new Error(
                              '以小写字母开头，不能使用中文或大写字母，特殊符号仅允许"@"、"."、"_"、"—"，长度为6-20个字符。'
                          )
                      );
                callback();
            }
        ...
        var validatePwd = (rule, value, callback) => {
            if (value === "") {
                ...
                reg.test(value)
                    ...
                    : callback(
                          new Error(
                              "必须包含字母、数字和特殊字符（特殊符号仅允许“@”、“.”、“_”、“—”。）,长度至少为8个字符。"
                          )
                      );
                callback();
            }
