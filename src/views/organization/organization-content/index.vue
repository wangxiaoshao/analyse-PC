    ...
    <div class="organization-content" v-loading="loading">
        <div class="organization-wrap" v-if="content[0]">
            <div class="organization-info">
                <span
                    v-if="content[0].nodeType === 1"
                    class="content-ico iconfont iconzuzhijigou"
                ></span>
                <span
                    v-if="content[0].nodeType === 2"
                    class="content-ico iconfont icondanwei"
                ></span>
                <span
                    v-if="content[0].nodeType === 3"
                    class="content-ico iconfont iconbumen"
                ></span>
                <span
                    class="organization-value"
                    v-html="content[0].name"
                ></span>
                <el-button
                    v-if="content[0].nodeType === 1"
                    @click.native="openEditNode(content[0])"
                    >编辑</el-button
                >
                <el-button
                    v-if="content[0].nodeType === 2"
                    @click.native="openEditUnit(content[0])"
                    >编辑</el-button
                >
                <el-button
                    v-if="content[0].nodeType === 3"
                    ...
                    >编辑</el-button
                >
                <el-button @click="toLogData" style="margin-left: 5px;"
                    >日志</el-button
                >
            </div>
                        ...
                        <el-popover placement="bottom" width="100">
                            ...
                            >
                                ...
                                <div
                                    ...
                                    v-if="
                                        showAddUnitFlag && hasRight('orgCreate')
                                    "
                                    @click="goAddUnit"
                                >
                                    添加单位
    ...
    methods: {
        ...
        init(type) {
            if (type === "back") {
                ...
                this.backInfo = Object.assign(
                    this.backInfo,
                    this.organization.backInfo
                );
            } else {
