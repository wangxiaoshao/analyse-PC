    ...
    <div class="choose-content">
        ...
        >
            ...
            <el-button
                class="choose-btn"
                slot="reference"
                v-if="!disabledFlag && this.$route.name !== 'PersonDetail'"
                >选择关联系统</el-button
            >
        </el-popover>
        <div>
            ...
            <div style="color: #58a4f3; font-size: 10px;" v-if="isCreate">
                请先填写账号和密码，否则关联系统无效
            </div>
        </div>
    </div>
...
export default {
    ...
    methods: {
        ...
        changeSlectedList() {
            ...
            this.slectedList = this.appList.filter((app) =>
                selectedIds.includes(app.appId)
            );
        },
        ...
        handleClose(item, index) {
            if (this.isCreate || !item.accountId) {
                // 创建账号关联、或者没有 accountId
                // alert(111)
